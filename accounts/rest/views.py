...
from .serializers import (PlayerAddFriendsSerializer, PlayerRemoveFriendsSerializer
                          , PlayerUpdateFriendsSerializer, RankSerializer, ProfileSerializer
                          , PlayerSerializer, PlayerSeasonGradeSerializer, LootOwnerShipSerializer,
                          ChampionOwnerShipSerializer, SkinOwnerShipOutSerializer, SkinOwnerShipSerializer,
                          ChampionOwnerShipOutSerializer, MessageSerializer)
...
from rest_framework.response import Response
from .permissions import IsPurchasableSkinOrReadOnly
...
class SkinOwnerShipViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsPurchasableSkinOrReadOnly]
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(SOS_serializer.data, status=status.HTTP_201_CREATED, headers=headers)
...
class ChampionOwnerShipViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(COS_serializer.data, status=status.HTTP_201_CREATED, headers=headers)
