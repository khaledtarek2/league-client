...
from accounts.rest.views import (MessageViewSet, PlayerAddFriendsView, PlayerRemoveFriendsView, PlayerViewSet, PlayerUpdateFriendsView
                                 , ProfileViewSet,PlayerSeasonGradeyViewSet, RankViewSet, LootOwnerShipViewSet
                                 , ChampionOwnerShipViewSet, SkinOwnerShipViewSet)     
...
router.register(r'champion_ownerships', ChampionOwnerShipViewSet, basename='champion_os')
...
urlpatterns = [
    ...
    path('api/messages/<int:sender>/<int:receiver>/', views.message_view, name='message-detail'),
