...
class PlayerAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        ("PersonalizedData", {"fields": ("level", "server", "profile", "friends")}),
        # ('Ownage', {
        #     'fields': ('owned_loot')
        #     }),
    )
...
class ProfileAdmin(admin.ModelAdmin):
    ...
    search_fields = ["rank__rank", "rank__mode"]
...
{}
        ...
        return format_html(
            ...
            (
                (
                    champion_m.champion.name,
                    profile.mastries.get(pk=champion_m.champion.pk),
                ),
                (
                    champion_m.champion.name,
                    profile.mastries.get(pk=champion_m.champion.pk),
