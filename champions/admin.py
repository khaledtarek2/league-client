...
class ChampionAdmin(admin.ModelAdmin):
    fieldsets = (
        ("ChampionInfo", {"fields": ("name", "title", "price_rp", "price_be")}),
        ("ChampionType", {"fields": ("category", "damage_type")}),
        (
            "Personalized",
            {
                "fields": (
    ...
    list_display = ("name", "title", "price_be", "is_freetoplay", "disabled")
    list_filter = [
        "is_freetoplay",
        "release_date",
        "difficulty",
    ...
    search_fields = ["name", "title", "price_rp", "price_be", "category"]
...
class ChampionMasteryAdmin(admin.ModelAdmin):
    fields = ["points", "title", "level", "player", "champion"]
    list_display = ("points", "title", "level", "player", "champion")
